...
const argv = yargs
  ...
  .option('before', {
    alias: 'before',
    type: 'string',
    description: 'Your npm Cypress command with before hook'
  })
  .option('after', {
    alias: 'after',
    type: 'string',
    description: 'Your npm Cypress command with after hook'
  })
  .option('threads', {
    alias: 't',
    type: 'number',
  ...
  .option('logDir', {
    alias: 'ld',
    type: 'string',
    description: 'Cypress Logs output dir'
  })
  .option('reporter', {
    alias: 'r',
    type: 'string',
  ...
  .option('outWeightsJSON', {
    alias: 'ow',
    type: 'string',
    description: 'Output Parallel weights json file'
  })
  .option('baseWeightTime', {
    alias: 'bwt',
    type: 'string',
    description: 'The time corresponding to the base weight'
  })
  .option('affinityConfig', {
    alias: 'affinity',
    type: 'string',
    description: 'Parallel threads affinity'
  }).argv;
...
const settings = {
  ...
  outWeightsJSON: argv.outWeightsJSON
    ? argv.outWeightsJSON || argv.weightsJson
    : 'cypress/parallel-weights.json',
  baseWeightTime: argv.baseWeightTime,
  affinityConfig: argv.affinityConfig,
  defaultWeight: 1,
